...
palavras=['ornitorinco','cotonete','graviola','borrifador','sudanês','guatemalteco','libélula','berinjela','lêmure']
...
def Camuflando_Plavra(palavra_escolhida,palavra_camuflada,tentativas_de_letras):
...
while True:
    ...
    # declarando a posição do mouse
    mouse=pg.mouse.get_pos()
    mouse_position_x=mouse[0]
    mouse_position_y=mouse[1]

    # declarando variável do click do mouse
    ...
    palavra_camuflada=Camuflando_Plavra(palavra_escolhida,palavra_camuflada,tentativas_de_letras)
    tentativas_de_letras,chance=Tentando_uma_Letra(tentativas_de_letras,palavra_escolhida,letra,chance)
    palavra=Palavra_do_Jogo(window,palavra_camuflada)
